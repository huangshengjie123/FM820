...
//    if ([self.dataSource respondsToSelector:@selector(nameDateArrayInGenericChart:)]) {
//        self.genericAxis.xLineNameArray = [NSMutableArray arrayWithArray:[self.dataSource nameDateArrayInGenericChart:self]];
//    }
//    
